...
export default function TermsOfService() {
  return (
    <div className="mx-4 sm:mx-auto max-w-4xl text-lg">
      <h1 className="text-2xl my-6">
        <strong>Terms and Conditions</strong>
      </h1>

      <p className="mb-3">Welcome to QuickDict!</p>

      <p className="mb-3">
        These terms and conditions outline the rules and regulations for the use
        of QuickDict&apos;s Website, located at quickdict.io.
      </p>

      <p className="mb-3">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use QuickDict if you do not agree to take
      ...
      <p className="mb-3">
        ...
        assistance to the Client in the most appropriate manner &apos;s needs in
      ...
      <p className="mb-3">
        We employ the use of cookies. By accessing QuickDict, you agreed to use
        cookies in agreement with the QuickDict&apos;s Privacy Policy.{" "}
      </p>
      ...
      <p className="mb-3">
        Unless otherwise stated, QuickDict and/or its licensors own the
        intellectual property rights for all material on QuickDict. All
        intellectual property rights are reserved. You may access this from
        QuickDict for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p className="mb-3">You must not:</p>
      <ul className="mb-3 ml-8">
        <li className="mb-1">Republish material from QuickDict</li>
        <li className="mb-1">
          Sell, rent or sub-license material from QuickDict
        </li>
        <li className="mb-1">
          Reproduce, duplicate or copy material from QuickDict
        </li>
        <li className="mb-3">Redistribute content from QuickDict</li>
      </ul>

      <p className="mb-3">
        This Agreement shall begin on the date hereof. Our Terms and Conditions
        were created with the help of the{" "}
        <Link href="https://www.freetoolshub.com/" className="underline">
      ...
      <p className="mb-3">
        ...
        QuickDict does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of QuickDict,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, QuickDict shall not be liable
      ...
      <p className="mb-3">
        QuickDict reserves the right to monitor all Comments and to remove any
      ...
      <p className="mb-3">
        You hereby grant QuickDict a non-exclusive license to use, reproduce,
      ...
      <p className="mb-3">
        ...
        the hyperlink compensates the absence of QuickDict; and (d) the link is
      ...
      <p className="mb-3">
        ...
        e-mail to QuickDict. Please include your name, your organization name,
      ...
      <p className="mb-3">
        No use of QuickDict&apos;s logo or other artwork will be allowed for
